...
df = origindf[['age', 'gender', 'sexori', 'raceall', 'trauma_sum', \
               ...
               'gettherapy', 'sum_alter', 'sum_family', 'sum_home_friends',\
               'sum_street_friends', 'sum_unknown_alter', 'sum_talk_once_week', 'sum_alter3close', \
...
f.write(lbl)
f.write ("'\n\nOverall number of samples: " + str(dfn.shape[0])+'\n')
f. write ("Accuracy:" + str(accuracy_score(y_test,y_predicted))+'\n')
