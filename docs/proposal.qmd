...
- Missing data
    ...
    - 4% of data set mising for suicideideation and planning (36 and 40 samples respectively)
- Imputed data (MICE)
    - Not statistically significant in terms of AUC comparison with listwise deletion
- Imbalanced classes
...
- 1 of the 6 datasets used in the paper is publicly available - Breast Cancer dataset from UCI Machine Learning Repository
- This will be used to test and compare our implementation of the algorithm
- With satisfactory results, we will apply the algorithm to the suicide dataset
