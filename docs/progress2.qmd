...
## Tree Distance
 $$
 d(\mathbbm{T}_1, \mathbbm{T}_2)
        \ =\ \min_{\bm x} & \quad \sum_{p \in \mathcal{P}(\mathbb{T}_1)} \sum_{q \in \mathcal{P}(\mathbb{T}_2)} d(p,q) x_{pq} 
        + \sum_{p \in \mathcal{P}(\mathbb{T}_1)} w(p) x_{p}\\
        \text{s.t.} & \quad \sum_{q \in \mathcal{P}(\mathbb{T}_2)} x_{pq} + x_{p} = 1, \quad \forall p \in \mathcal{P}(\mathbb{T}_1) \\
        & \quad \sum_{p \in \mathcal{P}(\mathbb{T}_1)} x_{pq} = 1, \quad \forall q \in \mathcal{P}(\mathbb{T}_2) \\
        & \quad x_{pq} \in \{0,1\}, \quad x_{p} \in \{0,1\}, \qquad \forall p \in \mathcal{P}(\mathbb{T}_1), \quad \forall q \in \mathcal{P}(\mathbb{T}_2)
